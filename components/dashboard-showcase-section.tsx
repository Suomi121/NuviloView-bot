    ...
    <section id="dashboard-demo" className="relative overflow-hidden px-6 py-24 sm:py-32">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <a href="/demo#thirty-second-demo" className="mt-7 inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-bold text-primary-foreground shadow-lg shadow-primary/20 transition-transform hover:-translate-y-0.5">30秒デモを見る <ArrowRight className="h-4 w-4" /></a>
        </div>
