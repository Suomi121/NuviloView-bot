...
export const RETENTION_POLICIES = [
  ...
  {
    id: "message-import-job",
    table: "history_import_job",
    timestamp: "completedAt",
    keyColumns: ["id"],
    days: 90,
    requiredIndex: "history_import_job_terminal_completed_idx",
    predicate: `"status" IN ('cancelled', 'completed', 'failed')`,
  },
  {
    id: "message-import-audit",
    table: "message_import_audit_event",
    timestamp: "createdAt",
    keyColumns: ["id"],
    days: 90,
    requiredIndex: "message_import_audit_created_idx",
    predicate: "TRUE",
  },
  {
