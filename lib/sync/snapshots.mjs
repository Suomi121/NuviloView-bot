...
export function createSnapshotService(
  ...
  function writeRuntimeSnapshot(runtime = {}, generatedAt = now()) {
    ...
    return storage.snapshots.upsert({
      ...
      payload: {
        schemaVersion: 1,
        runtimeMode: sanitizeRuntimeValue(runtime.runtimeMode ?? "LOCAL_FIRST"),
        botStatus: sanitizeRuntimeValue(runtime.botStatus ?? "UNKNOWN"),
        workerStatus: sanitizeRuntimeValue(runtime.workerStatus ?? "RUNNING"),
