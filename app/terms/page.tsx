    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-24 pt-32">
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-muted-foreground">
          <TermsSection title="1. 適用"><p>本規約は、NuviloView:OEMおよびNuviloChan Bot（以下「本サービス」）の利用条件を定めるものです。本サービスを利用した時点で、本規約とプライバシーポリシーに同意したものとみなします。本サービスはDiscord公式の提供・提携サービスではありません。</p></TermsSection>
          <TermsSection title="2. サービス内容"><p>本サービスは、Discordコミュニティの運営を支援するため、Botが取得したメンバー数、メッセージ数、リアクション、通話時間、アクティビティ、チャンネル権限状態および検索機能用のメッセージ本文を分析・表示します。ダッシュボードでは取得済みデータを定期的に更新表示します。</p></TermsSection>
          ...
          <TermsSection title="4. データと可用性"><p>本サービスは継続的な提供に努めますが、データの完全性、正確性、継続的な提供を保証するものではありません。Bot停止、Discord API、チャンネル権限、通信障害その他の理由により、記録やライブ表示が遅延・欠落する場合があります。</p></TermsSection>
