...
| Cross-platform migration checksum remediation | Migration validation and runner | 2026-08-21 20:33 | pending | START | SQL checksum input is normalized to LF so Windows and Linux validate the same immutable content. | Local manifest and migration tests passed; PR rerun pending |
