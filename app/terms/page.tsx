      ...
      <section className="mx-auto max-w-3xl px-6 pb-24 pt-32">
        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-muted-foreground">
          ...
          <TermsSection title="3. アカウントと利用資格">
            <p>利用者は、GoogleまたはDiscordの正確なアカウント情報を使用し、Discord連携を利用する場合はDiscordの利用条件および年齢要件を満たすものとします。GoogleログインだけではDiscordサーバー情報へアクセスできず、サーバー機能の利用には管理権限を確認できるDiscordアカウントの連携が必要です。利用者は自身のアカウント、セッションおよび端末を適切に管理し、不正利用を発見した場合は速やかにサポートへ連絡してください。</p>
          </TermsSection>
